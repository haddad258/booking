...
export default function Favorites() {
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 sm:py-12">
      <h1 className="font-display mb-1 text-3xl font-extrabold text-ink dark:text-white sm:text-4xl">Saved properties</h1>
      ...
      {loading || favoritesLoading ? (
        ...
        <div className="flex flex-col items-center justify-center rounded-3xl border border-dashed border-brand-500/25 dark:border-white/20 py-20 text-center">
          <HeartIcon className="mb-3 h-12 w-12 text-brand-500/25" />
