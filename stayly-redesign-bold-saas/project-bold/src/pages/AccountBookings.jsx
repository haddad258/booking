...
export default function AccountBookings() {
  ...
  return (
    <div className="rounded-3xl border border-brand-500/10 dark:border-white/10 bg-white dark:bg-brand-900 p-6">
      <h2 className="eyebrow mb-5 text-ink dark:text-white">Your bookings</h2>
      ...
      {loading ? (
        ...
        <div className="flex flex-col gap-3">
          {bookings.map((b) => (
            <div key={b.id} className="flex flex-wrap items-start justify-between gap-3 rounded-2xl border border-brand-500/10 dark:border-white/10 p-4">
              <div>
