  ...
  return (
    <div className="rounded-3xl border border-brand-500/10 dark:border-white/10 bg-white dark:bg-brand-900 p-6">
      <div className="mb-4 flex items-center justify-between">
        ...
        <RouterLink to="/account/bookings" className="text-sm font-semibold text-brand-600 dark:text-gold-300 hover:underline">View all</RouterLink>
      </div>
      ...
      {loading ? (
        ...
        <div className="flex flex-col gap-3">
          {bookings.map((b) => (
            <div key={b.id} className="rounded-2xl border border-brand-500/10 dark:border-white/10 p-4">
