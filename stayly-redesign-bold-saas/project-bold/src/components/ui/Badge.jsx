const COLORS = {
  default: 'bg-brand-500/8 text-brand-700 border-brand-500/15 dark:bg-white/8 dark:text-white/85 dark:border-white/15',
  gold: 'bg-gold-100 text-gold-700 border-gold-300/60 dark:bg-gold-400/15 dark:text-gold-300 dark:border-gold-400/30',
