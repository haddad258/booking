...
const FIELD_BASE = [
  'w-full rounded-2xl border bg-white dark:bg-brand-900 px-3.5 py-2.5 text-sm text-ink dark:text-white placeholder:text-ink/40 dark:placeholder:text-white/40',
  ...
  return (
    <label className="block">
      ...
      <input
        ...
        className={[
          FIELD_BASE,
          error ? 'border-red-400 focus:ring-red-200' : 'border-brand-500/15 dark:border-white/15 focus:border-brand-500 dark:focus:border-gold-400',
          className,
        ].join(' ')}
        {...props}
      />
  ...
  return (
    <label className="block">
      ...
      <select
        ...
        className={[
          FIELD_BASE,
          error ? 'border-red-400' : 'border-brand-500/15 dark:border-white/15 focus:border-brand-500 dark:focus:border-gold-400',
          className,
        ].join(' ')}
        {...props}
      >
