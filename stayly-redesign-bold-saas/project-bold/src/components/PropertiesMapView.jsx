...
export default function PropertiesMapView({ properties, type, activeId, onHover }) {
  ...
  return (
    <div className="relative h-full w-full overflow-hidden rounded-3xl border border-brand-500/10 dark:border-white/10">
          ...
          >
            <Popup minWidth={220}>
              <div className="w-full">
                ...
                <p className="mb-2 font-display text-base font-extrabold text-gradient">
                ...
                <RouterLink
                  to={detailPath(p)}
                  className="inline-block w-full rounded-full brand-gradient px-3 py-1.5 text-center text-xs font-semibold text-white"
                >
