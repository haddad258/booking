  ...
  render() {
    ...
    return (
      <div className="flex min-h-screen flex-col items-center justify-center bg-canvas px-4 text-center">
        ...
        <h1 className="font-display mb-2 text-2xl font-bold text-ink">Something went wrong</h1>
        ...
        <div className="flex gap-3">
          <button
            ...
            className="rounded-xl border-1.5 border-brand-800/20 px-5 py-2.5 text-sm font-semibold text-ink hover:border-brand-800/40 hover:bg-brand-50"
          >
            Reload page
          </button>
          <a
