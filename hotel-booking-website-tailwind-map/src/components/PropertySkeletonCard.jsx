...
export default function PropertySkeletonCard() {
  return (
    <div className="overflow-hidden rounded-2xl border border-brand-800/10 bg-white">
      <div className="h-48 w-full animate-pulse bg-brand-100" />
      <div className="p-4">
        <div className="mb-2 h-5 w-3/4 animate-pulse rounded bg-brand-100" />
        <div className="mb-3 h-3 w-1/2 animate-pulse rounded bg-brand-100" />
