...
export default function AuthLayout() {
  ...
  return (
    <div
      className="flex min-h-screen items-center justify-center bg-canvas dark:bg-brand-950 p-4"
    ...
    >
      <div className="w-full max-w-md rounded-2xl border border-brand-800/10 dark:border-white/10 bg-white dark:bg-brand-800 p-8 shadow-[0_24px_60px_-24px_rgba(13,19,33,0.28)] sm:p-10">
        <RouterLink to="/" className="mb-8 flex items-center gap-2">
          ...
          <span className="font-display text-xl font-semibold text-ink dark:text-white">{t('app.name')}</span>
        </RouterLink>
        <Outlet />
      </div>
    </div>
