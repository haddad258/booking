  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="rounded-2xl border border-brand-800/10 dark:border-white/10 bg-white dark:bg-brand-800 p-6">
        <h2 className="font-display mb-4 text-lg font-semibold text-ink dark:text-white">Profile</h2>
        ...
        {user?.username && (
          <div className="mb-4 rounded-xl bg-brand-50 dark:bg-white/5 px-4 py-3">
      ...
      <div className="rounded-2xl border border-brand-800/10 dark:border-white/10 bg-white dark:bg-brand-800 p-6">
        <h2 className="font-display mb-4 text-lg font-semibold text-ink dark:text-white">Addresses</h2>
        <div className="mb-4 flex flex-col gap-2">
          {addresses.map((a) => (
            <div key={a.id} className="flex items-center justify-between rounded-xl border border-brand-800/10 dark:border-white/10 p-3">
