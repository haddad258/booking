  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 sm:py-16">
      <div className="grid grid-cols-1 items-center gap-10 lg:grid-cols-2">
        <div>
          <h1 className="font-display mb-4 text-3xl font-semibold text-ink dark:text-white sm:text-4xl">Our story</h1>
          ...
          <h2 className="font-display mb-1 mt-6 text-xl font-semibold text-ink dark:text-white">Mission</h2>
          <p className="mb-2 text-ink/70 dark:text-white/70">
          ...
          <h2 className="font-display mb-1 mt-6 text-xl font-semibold text-ink dark:text-white">Vision</h2>
        ...
        <ResponsiveImage src={IMAGE} alt="" frameClassName="h-80 sm:h-[420px]" className="rounded-3xl" />
      </div>
    </div>
  );
}
