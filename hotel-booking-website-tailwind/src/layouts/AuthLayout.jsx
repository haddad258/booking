...
export default function AuthLayout() {
  ...
  return (
    <div
      ...
      style={{ backgroundImage: 'radial-gradient(circle at 85% 8%, rgba(73,117,96,0.12), transparent 45%), radial-gradient(circle at 10% 90%, rgba(201,166,107,0.16), transparent 40%)' }}
    >
      <div className="w-full max-w-md rounded-2xl border border-brand-800/10 bg-white p-8 shadow-[0_24px_60px_-24px_rgba(28,38,32,0.25)] sm:p-10">
