    ...
    <Card className="hover-lift" sx={{ position: 'relative', overflow: 'hidden' }}>
      {onToggleFavorite && (
        <IconButton
          ...
          sx={{ position: 'absolute', top: 12, right: 12, zIndex: 2, bgcolor: 'rgba(255,255,255,0.92)', backdropFilter: 'blur(6px)', '&:hover': { bgcolor: '#fff' } }}
        >
        ...
        <CardContent sx={{ p: 2.25 }}>
          ...
          <Stack direction="row" justifyContent="space-between" alignItems="baseline">
            <Typography variant="h6" fontWeight={800} className="gradient-text">
              ...
              <Typography component="span" variant="caption" color="text.secondary" sx={{ WebkitTextFillColor: 'initial', background: 'none' }}> {t('listing.perNight')}</Typography>
            </Typography>
          </Stack>
        </CardContent>
      </CardActionArea>
