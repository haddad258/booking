...
export default function SearchBar() {
  ...
  return (
    <Paper
      elevation={0}
      className="glass"
      sx={{ p: { xs: 2, md: 2.5 }, borderRadius: 3, border: '1px solid rgba(255,255,255,0.4)', maxWidth: 920, mx: 'auto' }}
    >
      <ToggleButtonGroup
        value={type}
        exclusive
        ...
        size="small"
        sx={{ mb: 2, bgcolor: 'background.paper', borderRadius: 999 }}
      >
        <ToggleButton value="hotel" sx={{ borderRadius: 999, px: 2.5 }}>{t('nav.hotels')}</ToggleButton>
        <ToggleButton value="chalet" sx={{ borderRadius: 999, px: 2.5 }}>{t('nav.chalets')}</ToggleButton>
      </ToggleButtonGroup>
