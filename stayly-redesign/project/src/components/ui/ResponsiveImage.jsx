...
export default function ResponsiveImage({
  ...
  return (
    <div className={`relative w-full overflow-hidden bg-ink/5 dark:bg-white/5 ${frameClassName} ${className}`}>
      {status !== 'loaded' && (
        <div className="absolute inset-0 animate-pulse bg-ink/5 dark:bg-white/5" aria-hidden="true" />
      )}
      <img
        src={resolvedSrc}
        alt={alt}
