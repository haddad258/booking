...
export default function ThemeToggle({ className = '' }) {
  ...
  return (
    <button
      ...
      className={`relative flex h-9 w-9 items-center justify-center rounded-full text-ink transition hover:bg-ink/5 dark:text-white dark:hover:bg-white/10 ${className}`}
    >
      <SunIcon
