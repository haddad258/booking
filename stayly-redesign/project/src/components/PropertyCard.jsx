...
export default function PropertyCard({ property, type, isFavorite, onToggleFavorite }) {
  ...
  return (
    <div className="hover-lift group overflow-hidden rounded-[20px] border border-ink/10 dark:border-white/10 bg-white dark:bg-brand-800">
      ...
      <RouterLink to={detailPath} className="block p-4">
        ...
        <p className="mt-3 font-display text-xl font-semibold text-brand-700 dark:text-gold-300">
