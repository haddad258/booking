  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 sm:py-12">
      <div className="mb-4 flex flex-wrap items-start justify-between gap-3">
        <div>
          <h1 className="font-display text-3xl font-medium text-ink dark:text-white sm:text-4xl">{hotel.name}</h1>
      ...
      <div className="grid grid-cols-1 gap-10 lg:grid-cols-3">
        <div className="lg:col-span-2">
          ...
          <div className="mb-8 border-t border-ink/10 dark:border-white/10" />
        ...
        <div>
          <div className="sticky top-24 rounded-[20px] border border-ink/10 dark:border-white/10 bg-white dark:bg-brand-800 p-6">
            <h2 className="eyebrow mb-5 text-ink dark:text-white">{t('detail.selectRoom')}</h2>
            <div className="flex flex-col gap-3">
              {hotel.rooms?.length ? (
                hotel.rooms.map((room) => (
                  <div key={room.id} className="rounded-2xl border border-ink/10 dark:border-white/10 p-4">
                    <div className="flex items-center justify-between">
                      ...
                      <p className="font-display font-semibold text-brand-700 dark:text-gold-300">${Number(room.price).toFixed(0)}</p>
                    </div>
                    <Button
                      fullWidth
                      size="sm"
      ...
      {similar.length > 0 && (
        <div className="mt-14">
          <h2 className="font-display mb-6 text-2xl font-medium text-ink dark:text-white">{t('detail.similar')}</h2>
