  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="rounded-[20px] border border-ink/10 dark:border-white/10 bg-white dark:bg-brand-800 p-6">
        ...
        {user?.username && (
          <div className="mb-4 rounded-2xl bg-brand-50 dark:bg-white/5 px-4 py-3">
      ...
      <div className="rounded-[20px] border border-ink/10 dark:border-white/10 bg-white dark:bg-brand-800 p-6">
        ...
        <div className="mb-4 flex flex-col gap-2">
          {addresses.map((a) => (
            <div key={a.id} className="flex items-center justify-between rounded-2xl border border-ink/10 dark:border-white/10 p-3">
