...
export default function Contact() {
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-10 sm:px-6 sm:py-16">
      <h1 className="font-display mb-2 text-3xl font-medium text-ink dark:text-white sm:text-4xl">{t('contact.title')}</h1>
      <p className="mb-8 text-ink/60 dark:text-white/60">{t('contact.subtitle')}</p>

      <div className="grid grid-cols-1 gap-8 lg:grid-cols-5">
        <div className="lg:col-span-3 rounded-[20px] border border-ink/10 dark:border-white/10 bg-white dark:bg-brand-800 p-6">
        ...
        <div className="lg:col-span-2 overflow-hidden rounded-[20px] border border-ink/10 dark:border-white/10">
          <iframe
            title="map"
