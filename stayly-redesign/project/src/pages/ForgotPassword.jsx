...
export default function ForgotPassword() {
  ...
  return (
    <div>
      <h1 className="font-display mb-6 text-2xl font-medium text-ink dark:text-white">{t('auth.resetPassword')}</h1>
      {sent ? (
      ...
      <p className="mt-6 text-center text-sm">
        <RouterLink to="/login" className="font-semibold text-brand-700 dark:text-gold-300 hover:underline">Back to log in</RouterLink>
      </p>
    </div>
  );
}
