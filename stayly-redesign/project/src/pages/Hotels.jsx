  ...
  return (
    <div className="mx-auto max-w-[1600px] px-4 py-6 sm:px-6 sm:py-8">
      <div className="mb-4 flex flex-wrap items-center justify-between gap-3">
        <h1 className="font-display text-3xl font-medium text-ink dark:text-white sm:text-4xl">{t('nav.hotels')}</h1>
              ...
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                {hotels.map((h) => (
                  <div
                    ...
                    className={`rounded-[20px] transition ${hoveredId === h.id ? 'ring-2 ring-gold-400' : ''}`}
                  >
