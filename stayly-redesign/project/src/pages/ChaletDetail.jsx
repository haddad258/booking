  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 sm:py-12">
      <div className="mb-4 flex flex-wrap items-start justify-between gap-3">
        <div>
          <h1 className="font-display text-3xl font-medium text-ink dark:text-white sm:text-4xl">{chalet.name}</h1>
      ...
      <div className="grid grid-cols-1 gap-10 lg:grid-cols-3">
        ...
        <div>
          <div className="sticky top-24 rounded-[20px] border border-ink/10 dark:border-white/10 bg-white dark:bg-brand-800 p-6">
            <p className="font-display text-2xl font-semibold text-brand-700 dark:text-gold-300">
