...
export default function AccountPassword() {
  ...
  return (
    <div className="rounded-[20px] border border-ink/10 dark:border-white/10 bg-white dark:bg-brand-800 p-6">
      <h2 className="eyebrow mb-5 text-ink dark:text-white">Change password</h2>
      {success && <div className="mb-4 rounded-2xl bg-emerald-50 px-4 py-3 text-sm text-emerald-700">Password changed successfully</div>}
